 ...
 * java.io.Serializable表示支持序列化的功能
 * java.lang.Cloneable，表示支持ArrayList支持克隆
 * */
        ...
        implements List<E>, RandomAccess, Cloneable, java.io.Serializable
{
     ...
     * @serial
     */
    //代表的是ArrayList 已使用 elementData 的元素的数量
    private int size;
    ...
    private Object[] grow() {
        //要求扩容后至少比原有大 1 。因为是最小扩容的要求，实际是允许比它大。
        return grow(size + 1);
    }
